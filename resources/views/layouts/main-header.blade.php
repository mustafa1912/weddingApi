 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{route('dashboard')}}"><img style="width: 50px;height: 50px" src="{{asset('public/dist/img/school.jpg')}}" alt=""></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('public/assets/images/logo-icon-dark.png')}}"
                        alt=""></a>
            </div>
            <!-- Top bar left -->
...
{{--         <li style="color: #00c054;font-size: 20px">[Date of This Day is: {{date('d-m-Y')}}]</li>--}}
{{--         <li style="color: blue;font-size: 20px">[the day is : {{date('l')}}]</li>--}}
{{--         <li style="color: green;font-size: 20px">[the time is : {{date('h:i:s')}}]</li>--}}
{{--         <li></li>--}}
{{--     </ul>--}}


            <ul class="nav navbar-nav ml-auto" style="caret: blue">
{{--                <ul>--}}
...
{{--                </ul>--}}
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{asset('public/dist/img/school.jpg')}}" alt="avatar">
                    </a>
