    ...
    var P = function(h) {
        ...
        function gb(a) {
            var a = a.oBrowser,
                ...
                .append(
                    ...
                    .append(h('<div class="test"/>').css({ width: "100%", height: 10 }))
                )
                .appendTo("body"),
                c = b.find(".test");
        ...
        function Fa(a, b) {
            var c = m.defaults.column,
                ...
                c = h.extend({}, m.models.oColumn, c, { nTh: b ? b : Q.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [e], mData: c.mData ? c.mData : e, idx: e });
            a.aoColumns.push(c);
            c = a.aoPreSearchCols;
        ...
        function ka(a, b, c) {
            ...
            !b.bSortable || (!a && !c) ?
                ((b.sSortingClass = e.sSortableNone), (b.sSortingClassJUI = "")) :
                a && !c ?
                ((b.sSortingClass = e.sSortableAsc), (b.sSortingClassJUI = e.sSortJUIAscAllowed)) :
                !a && c ?
                ((b.sSortingClass = e.sSortableDesc), (b.sSortingClassJUI = e.sSortJUIDescAllowed)) :
                ((b.sSortingClass = e.sSortable), (b.sSortingClassJUI = e.sSortJUI));
        }
        ...
        function M(a) {
            ...
            if (-1 !== h.inArray(!1, b)) C(a, !1);
                ...
                if (0 !== i.length) {
                    ...
                    (b[0] = h("<tr/>", { class: d ? e[0] : "" }).append(h("<td />", { valign: "top", colSpan: aa(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
        ...
        function ra(a, b, c) {
            ...
            a.fnServerData ?
                ...
                (a.jqXHR = h.ajax(h.extend(o, { url: g || a.sAjaxSource }))) :
                h.isFunction(g) ?
                (a.jqXHR = g.call(j, b, i, a)) :
                ((a.jqXHR = h.ajax(h.extend(o, g))), (g.data = f));
        }
        ...
        function tb(a) {
            ...
            for (g = 0; g < c; g++)
                ...
                k.columns.push({ data: i, name: o.sName, searchable: o.bSearchable, orderable: o.bSortable, search: { value: l.sSearch, regex: l.bRegex } }),
                n("mDataProp_" + g, i),
        ...
        function ob(a) {
            var b = a.oClasses,
                ...
                i = h("input", b)
                .val(d.sSearch)
                .attr("placeholder", e.sSearchPlaceholder)
        ...
        function rb(a) {
            ...
            c || (a.aoDrawCallback.push({ fn: Bb, sName: "information" }), e.attr("role", "status").attr("aria-live", "polite"), h(a.nTable).attr("aria-describedby", b + "_info"));
            return e[0];
        }
        ...
        function Cb(a, b) {
            var c = a.fnFormatNumber,
                ...
                g = -1 === d;
            return b
                .replace(/_START_/g, c.call(a, e))
                .replace(/_END_/g, c.call(a, a.fnDisplayEnd()))
                .replace(/_MAX_/g, c.call(a, a.fnRecordsTotal()))
                .replace(/_TOTAL_/g, c.call(a, f))
                .replace(/_PAGE_/g, c.call(a, g ? 1 : Math.ceil(e / d)))
                .replace(/_PAGES_/g, c.call(a, g ? 1 : Math.ceil(f / d)));
        }
        ...
        function nb(a) {
            for (
                var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, d = h.isArray(e[0]), f = d ? e[0] : e, e = d ? e[1] : e, d = h("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), g = 0, j = f.length; g < j; g++
            )
        ...
        function Ta(a, b, c) {
            ...
            0 === f || -1 === d ?
                ...
                e + d < f && (e += d) :
                "last" == b ?
                (e = Math.floor((f - 1) / d) * d) :
                I(a, 0, "Unknown paging action: " + b, 5);
        ...
        function qb(a) {
            ...
            c = h("<div/>", { class: f.sScrollWrapper })
                .append(
                    ...
                    .css({ overflow: "hidden", position: "relative", border: 0, width: e ? (!e ? null : s(e)) : "100%" })
                    .append(
                ...
                .append(
                    ...
                    .css({ overflow: "auto", height: !d ? null : s(d), width: !e ? null : s(e) })
                    .append(b)
                );
            l &&
                c.append(
                    h("<div/>", { class: f.sScrollFoot })
                    .css({ overflow: "hidden", border: 0, width: e ? (!e ? null : s(e)) : "100%" })
                    .append(
        ...
        function Hb() {
            ...
            if (a === k) {
                var b = h("<p/>").css({ position: "absolute", top: 0, left: 0, width: "100%", height: 150, padding: 0, overflow: "scroll", visibility: "hidden" }).appendTo("body"),
        ...
        function U(a) {
            ...
            for (a = 0; a < o.length; a++) {
                ...
                for (c = f.length; b < c; b++)
                    (g = f[b]), (j = d[g].sType || "string"), o[a]._idx === k && (o[a]._idx = h.inArray(o[a][1], d[g].asSorting)), e.push({ src: i, col: g, dir: o[a][1], index: o[a]._idx, type: j, formatter: m.ext.type.order[j + "-pre"] });
            }
            return e;
        }
        ...
        function Jb(a) {
            for (var b, c, e = a.aoColumns, d = U(a), a = a.oLanguage.oAria, f = 0, g = e.length; f < g; f++) {
                ...
                c.bSortable &&
                    (0 < d.length && d[0].col == f ? (i.setAttribute("aria-sort", "asc" == d[0].dir ? "ascending" : "descending"), (c = j[d[0].index + 1] || j[0])) : (c = j[0]), (b += "asc" === c ? a.sSortAscending : a.sSortDescending));
        ...
        function Ua(a, b, c, e) {
            ...
            c && a.oFeatures.bSortMulti ?
                ((c = h.inArray(b, D(d, "0"))), -1 !== c ? ((b = g(d[c], !0)), null === b && 1 === d.length && (b = 0), null === b ? d.splice(c, 1) : ((d[c][1] = f[b]), (d[c]._idx = b))) : (d.push([b, f[0], 0]), (d[d.length - 1]._idx = 0))) :
                d.length && d[0][0] == b ?
                ((b = g(d[0])), (d.length = 1), (d[0][1] = f[b]), (d[0]._idx = b)) :
        ...
        function w(a, b, c, e) {
            var d = [];
            b &&
                (d = h.map(a[b].slice().reverse(), function(b) {
        ...
        function Wa(a, b) {
            ...
            b <= c ?
                (c = V(0, b)) :
                a <= e ?
                ((c = V(0, c - 2)), c.push("ellipsis"), c.push(b - 1)) :
                (a >= b - 1 - e ? (c = V(b - (c - 2), b)) : ((c = V(a - e + 2, a + e - 1)), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0));
            c.DT_el = "span";
            return c;
        }
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) I(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    E(p, d, [
                        ...
                        "fnStateSaveCallback",
                        "renderer",
                        "searchDelay", ["iCookieDuration", "iStateDuration"],
                    ...
                    i = p.oClasses;
                    d.bJQueryUI ?
                        (h.extend(i, m.ext.oJUIClasses, d.oClasses), d.sDom === l.sDom && "lfrtip" === l.sDom && (p.sDom = '<"H"lfr>t<"F"ip>'), p.renderer) ?
                        h.isPlainObject(p.renderer) && !p.renderer.header && (p.renderer.header = "jqueryui") :
                        (p.renderer = "jqueryui") :
                        h.extend(i, m.ext.classes, d.oClasses);
                    q.addClass(i.sTable);
                    ...
                    function(c) {
                        ...
                        return $a(
                            ...
                            function(a) {
                                ...
                                return a.nodeName && h.inArray(a, b) !== -1 ? [a._DT_RowIndex] :
                                    h(b)
                                    .filter(a)
                                    .map(function() {
        ...
        r("search()", function(a, b, c, e) {
            ...
            return a === k ?
                0 !== d.length ?
                d[0].oPreviousSearch.sSearch :
                k :
                this.iterator("table", function(d) {
                    d.oFeatures.bFilter && fa(d, h.extend({}, d.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === e ? !0 : e }), 1);
                });
        });
        ...
        r("destroy()", function(a) {
            ...
            return this.iterator("table", function(b) {
                ...
                b.bJUI &&
                    (h("th span." + e.sSortIcon + ", td span." + e.sSortIcon, g).detach(),
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: { sFirst: "الاولى", sLast: "الاخيرة", sNext: "التالى", sPrevious: "السابق" },
                sEmptyTable: "لا توجد بيانات فى هذا الجدول",
                sInfo: "عرض _START_ الى _END_ من _TOTAL_ مدخل",
                sInfoEmpty: "عرض 0 الى 0 من 0 مدخل",
                sInfoFiltered: "(تصفية من _MAX_ اجمالى مدخل)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "عرض&nbsp; _MENU_&nbsp; &nbsp; مدخل",
                sLoadingRecords: "Loading...",
                sProcessing: "Processing...",
                sSearch: "البحث&nbsp; : &nbsp; &nbsp; &nbsp; &nbsp;",
                sSearchPlaceholder: "",
                sUrl: "",
                sZeroRecords: "لا يوجد عناصر تطابق البحث",
            },
                        ...
                        m = function(b, e) {
                            ...
                            for (r = e.length; n < r; n++) {
                                ...
                                if (h.isArray(s)) {
                                    ...
                                    if (i) {
                                        t = h("<a>", { class: g.sPageButton + " " + k, "aria-controls": a.sTableId, "data-dt-idx": l, tabindex: a.iTabIndex, id: c === 0 && typeof s === "string" ? a.sTableId + "_" + s : null })
                                            .html(i)
                                            .appendTo(b);
                                        Va(t, { action: s }, u);
                                        l++;
            ...
            header: {
                ...
                jqueryui: function(a, b, c, e) {
                    h("<div/>")
                        ...
                        .append(b.contents())
                        .append(h("<span/>").addClass(e.sSortIcon + " " + c.sSortingClassJUI))
                        .appendTo(b);
                    h(a.nTable).on("order.dt.DT", function(d, f, g, h) {
                        if (a === f) {
                            d = c.idx;
                            ...
                            b.find("span." + e.sSortIcon)
                                ...
                                .addClass(h[d] == "asc" ? e.sSortJUIAsc : h[d] == "desc" ? e.sSortJUIDesc : c.sSortingClassJUI);
                        }
                    });
                },
            },
